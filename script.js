...
function makeCard(p, extraClass) {
  ...
  const label = `<span class="plabel" style="background:#fee2e2;color:#dc2626">${labelTxt}</span>`;
  ...
  return `
    <div class="pcard${extraClass ? ' '+extraClass : ''}" onclick="openDetail(${p.id})">
      ...
      <div class="pinfo">
        ...
        ${oldP}
        <button class="pbuy" type="button" onclick="event.stopPropagation(); openDetail(${p.id})">
          <svg class="pbuy-bag" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="16" height="16"><path d="M6 2L3 6v14a2 2 0 002 2h14a2 2 0 002-2V6l-3-4z"/><line x1="3" y1="6" x2="21" y2="6"/><path d="M16 10a4 4 0 01-8 0"/></svg>
